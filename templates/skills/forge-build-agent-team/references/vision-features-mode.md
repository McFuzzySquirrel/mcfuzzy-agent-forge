...
Load this file when: the source document is a Product Vision (`docs/product-vision.md`) with feature documents in `docs/features/`, and no `.agent.md` files exist in `HARNESS_AGENTS_DIR` beyond forge templates.
